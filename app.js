...
const z = require('zod')
const { valid, minVersion } = require('semver')
...
/**
 * UNA VEZ USANDO CORS LO PODRIAMOS TRASLADAR ARRIBA 
 * const ACCEPTED_ORIGINS = [
    'http://localhost:8080',
    'http://localhost:1234',
    'http://movies.com',
...
app.get('/movies', (req, res) => {
    ...
    /**
     * CUANDO USAMOS EL MIDDLEWARE CORS PODEMOS BORRAR TODA ESTA SECCION DE CODIGO
...
app.post('/movies', (req, res) => {
    ...
    //en base de datos
    const newMovie = {
        id: crypto.randomUUID(), // esto te crea un uuid v4
